...
class ReferencePipelineTests {
    ...
    @LocalData // Find the associated data in test/resources/uk/org/floop/jenkins_pmd/ReferencePipelineTests/FamilyReferencePipeline
    @WithTimeout(10000) // Override Jenkins test harness timeout. 180 seconds is not long enough.
    void "FamilyReferencePipeline"() {
        final CpsFlowDefinition flow = new CpsFlowDefinition('''
          familyReferencePipeline {}
        '''.stripIndent())
